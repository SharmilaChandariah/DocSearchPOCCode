...
def create_vector_store(pdf_file, output_txt_path, vector_store):
    # # Extract and combine text from all pages
    combined_text = extract_combine_text_from_pdf(pdf_file)
...
if __name__ == "__main__":
    ...
    for file in os.listdir(file_path):
        if file.endswith(".pdf"):
            ...
            output_txt_path = os.path.join("../processed_textfiles/", file.replace(".pdf", ".txt"))
            print(f'Output path: {output_txt_path}')
            create_vector_store(pdf_file, output_txt_path, vector_store)
    ...
    query = "What is Bayesian neuralnetworks?"
